  ...
  return (
    <section class="grid h-[100vh] place-items-center bg-background px-6 py-24 sm:py-32 lg:px-8">
      <div class="text-center">
        <p class="text-base font-semibold text-iris">404</p>
        <h1 class="mt-4 text-balance text-5xl font-semibold tracking-tight text-space-cadet sm:text-7xl capitalize">
          Page not found
        </h1>
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
          ...
          <Link to="#" class="text-sm font-semibold text-space-cadet hover:text-iris my-transition">
